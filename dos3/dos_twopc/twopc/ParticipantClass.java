...
public class ParticipantClass {
	...
	private void initialize() {
		...
		frame.getContentPane().setBackground(new java.awt.Color(176,224,230));
		...
		btnAbort.setBounds(350, 180, 106, 37);
		...
		btnCommit.setBounds(350, 120, 106, 37);
...
*/		JLabel lblEnterParticipantName = new JLabel("Enter Participant Name");
		...
		scrollPane.setBounds(33, 101, 300, 157);
		...
		btnState.setBounds(50, 50, 106, 37);
		frame.getContentPane().add(btnState);
		
		lblNewLabel = new JLabel("");
		lblNewLabel.setBounds(390, 70, 68, 14);
