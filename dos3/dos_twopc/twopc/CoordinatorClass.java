...
public class CoordinatorClass {
	...
	private void initialize() {
		...
		frmCoordinator.getContentPane().setBackground(new java.awt.Color(176,224,230));
		...
		scrollPane.setBounds(45, 152, 306, 185);
		...
		btnUsers.setBounds(50, 110, 89, 23);
		...
		btnState.setBounds(150, 110, 89, 23);
